...
| --- | --- | --- |
| **Username search** | Checks 100+ platforms in parallel with per-platform validators to cut false positives, then enriches hits with avatars, bios and follower counts. Reports the platforms it checked and *rejected*, with the reason. | web, CLI, API |
