...
object ImageProvenance {
    ...
    fun analyse(bytes: ByteArray, exifSoftware: String? = null): Report {
        ...
        if (c2pa) {
            markers += Marker(
                "Content Credentials",
                "A C2PA manifest is attached to this file",
            )
        }
            ...
            when {
                x.contains("compositeWithTrainedAlgorithmicMedia") -> {
                    ...
                    markers += Marker(
                        ...
                        "compositeWithTrainedAlgorithmicMedia — part of this image was " +
                ...
                x.contains("trainedAlgorithmicMedia") -> {
                    ...
                    markers += Marker(
                        "IPTC DigitalSourceType",
                        "trainedAlgorithmicMedia — the standard's marker for an image " +
                ...
                x.contains("algorithmicMedia") -> {
                    ...
                    markers += Marker(
                        "IPTC DigitalSourceType",
                        "algorithmicMedia — generated by software rather than captured",
                    )
                }
                x.contains("digitalCapture") -> {
                    ...
                    markers += Marker(
                        "IPTC DigitalSourceType",
                        "digitalCapture — the file states a camera took this",
                    )
                }
            }
        }
        ...
        if (generator != null) {
            markers += Marker("Generator name", "This file names $generator as its source")
        ...
        if (parameters != null) {
            ...
            markers += Marker(
                ...
                "The file carries the prompt and sampler settings used to create it",
            )
        }
        ...
        if (text.any {
            ...
            markers += Marker(
                "Generation workflow",
                "An embedded node graph of the generation pipeline",
            )
        }
